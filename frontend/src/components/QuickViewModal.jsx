...
// A fast "peek" at a poster without leaving the grid — full detail/config still lives on
// the Product Detail page (linked at the bottom) for people who want size/finish/border options.
    ...
    >
        ...
        >
          ...
          <div className="p-6 sm:p-8 relative">
            <button onClick={onClose} aria-label="Close" className="absolute top-5 right-5 p-2 rounded-full hover:bg-brand-smoke">
              <X size={18} />
            </button>
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className="bg-brand-black text-brand-yellow font-bold py-3.5 rounded-full flex items-center justify-center gap-2"
              >
