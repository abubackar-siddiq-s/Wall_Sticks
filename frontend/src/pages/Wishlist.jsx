...
export default function Wishlist() {
  ...
  const validItems = items.filter((product) => product && product._id)
  ...
  return (
    <div className="max-w-6xl mx-auto px-5 md:px-8 py-10">
      <h1 className="text-3xl md:text-4xl font-extrabold mb-8">
        My Wishlist <span className="text-black/40 font-medium text-xl">({validItems.length})</span>
      </h1>
              ...
              <div className="p-4">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    aria-label="Remove"
                    className="p-2.5 rounded-full border border-black/10 hover:bg-red-50 hover:border-red-200 text-black/40 hover:text-red-500 transition-colors"
                  >
                    <Trash2 size={14} />
                  </button>
                </div>
